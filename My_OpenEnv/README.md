...
```bash
# Required
HF_TOKEN=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
# Optional fallback if HF_TOKEN is not set
...
```bash
# Set your space URL
$env:HF_SPACE_URL = "https://huggingface.co/spaces/indianhacker001/OpenEnv_Grid_World"
